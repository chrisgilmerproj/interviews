...
# Default expenses in cents
DEFAULT_HOUSING_EXPENSE = 106100
...
def calculate_fixed_expenses_before_education(open_file):
    ...
    if not mortgage_tradeline_found:
        fixed_expenses_before_education += DEFAULT_HOUSING_EXPENSE
...
if __name__ == "__main__":
    ...
    with open(filename, 'r') as open_file:
        out = calculate_fixed_expenses_before_education(open_file)
